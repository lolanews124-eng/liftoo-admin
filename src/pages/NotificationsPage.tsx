...
export function NotificationsPage() {
  ...
  const { items, total, page, setPage, loading, reload, limit, error: listError } =
    usePaginatedList<AdminBroadcastRow>(adminApi.notificationBroadcasts, EMPTY_FILTERS);
      ...
      <div className="notifications-layout">
          ...
          <form onSubmit={send}>
            ...
            <div className="form-actions form-actions--start">
              <button type="submit" className="btn btn-primary" disabled={sending}>
                {sending ? 'Sending…' : audience === 'customer' ? 'Send to customers' : 'Send to assistants'}
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="card">
          ...
          <DataPanel
            ...
            emptyHint="Your sent notifications will appear here."
            onRetry={reload}
          >
